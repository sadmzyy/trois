...
`;var rr=I("ShaderMaterial",{props:{type:Object,default:()=>({uniforms:{},vertexShader:Li,fragmentShader:Oi})}},e=>new ve(Q(e,["color"])));function Ni(e,t,r){return e.split(t).join(r)}const $i=V.meshphong_frag.slice(0,V.meshphong_frag.indexOf("void main() {")),Ei=V.meshphong_frag.slice(V.meshphong_frag.indexOf("void main() {")),zi={uniforms:ze.merge([Vs.phong.uniforms,{thicknessColor:{value:new Y(16777215)},thicknessDistortion:{value:.1},thicknessAmbient:{value:0},thicknessAttenuation:{value:.1},thicknessPower:{value:2},thicknessScale:{value:10}}]),vertexShader:`
    #define USE_UV
    ${V.meshphong_vert}
  `,fragmentShader:`
    #define USE_UV
